...
public class LinkedListOfString {
    ...
    public LinkedListOfString subList(int start, int end){
    ...
    /*1) Acrescentar na classe LinkedListOfString um método que faça uma inserção ordenada dos elementos 
    ...
    /*2) Acrescentar na classe LinkedListOfString um método não recursivo que imprima 
    ...
    /*3) Acrescentar na classe LinkedListOfString um método recursivo que imprima 
        o conteúdo da lista de trás para frente.*/
    ...
    /*4) Acrescentar na classe LinkedListOfString o seguinte método: 
    ...
    /*5) Crie duas instâncias de LinkedListOfString na classe App e as inicialize com 100 valores 
    ...
    public LinkedListOfString union(LinkedListOfString lista2){ //On²
        LinkedListOfString lista1 = new LinkedListOfString();
        boolean aux = false;
    ...
    public LinkedListOfString intersect(LinkedListOfString lista2){ //On²
        LinkedListOfString intersect = new LinkedListOfString();
        LinkedListOfString lista1 = new LinkedListOfString();
        lista1 = this;
